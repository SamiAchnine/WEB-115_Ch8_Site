...
//method to refernece image of the poker card
...
function pokerDeck() {
   ...
   this.cards = [];
   // add card for each combination of suit & rank
   for (let i = 0; i < 4; i++) {
      for (let j = 0; j < 13; j++) {
         // add new pokercCard object
         this.cards.push(new pokerCard(suits[i], ranks[j]));
      }
   }
   // method to randomly sort cards in deck
...
// method to determine value of pokerHand
